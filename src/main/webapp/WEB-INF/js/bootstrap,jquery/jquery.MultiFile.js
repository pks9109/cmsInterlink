				...
				MultiFile.addToList = function (slave, slave_count, files) {
					...
					//$.each(files, function (i, file) {
						...
						var
							...
							//2019-02-11 권수 추가
							b = $('<a id="remove" class="MultiFile-remove" style="color: red; text-decoration: none;" href="#' + MultiFile.wrapID + '" onclick="remove(this)">' + MultiFile.STRING.remove + '</a>')
